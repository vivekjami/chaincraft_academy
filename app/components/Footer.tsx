        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              Empowering the next generation of blockchain developers with AI-powered learning, 
              visual tools, and hands-on experience.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">AI Tutor</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Blockchain Builder</a></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 ChainCraft Academy. All rights reserved.
            </p>
